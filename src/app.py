...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate student is not already signed up or on the waitlist
    ...
    if len(activity["participants"]) >= activity["max_participants"]:
        ...
        return {
            "message": f"Activity is full. Added {email} to the waitlist for {activity_name} (position {position})",
            "status": "waitlisted",
            "position": position
        }
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Check if student is on the waitlist and remove them
    if email in activity["waitlist"]:
    ...
    if activity["waitlist"]:
        ...
        return {"message": f"Unregistered {email} from {activity_name}. {promoted_email} has been promoted from the waitlist."}
